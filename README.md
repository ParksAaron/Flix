...
1. Easier more concrete ways of doing layout instead of messing with it and using arbritrary values.
2. Ways to target most phone / orientation types while coding. (Like flexbox with react)

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='flixdemo3' title='Video Walkthrough' width='' alt='Video Walkthrough' />
